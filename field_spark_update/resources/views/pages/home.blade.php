...
<head>
    ...
    <title>Field Spark Agricultural Portal | Home</title>
...
<body>
    ...
    <div class="welcome">
        <div class="container">
            <h3 class="agileits_w3layouts_head">Paddy Crop <span>Calendars</span></h3>
            <div class="w3_agile_image">
                <img src="images/1.png" alt=" " class="img-responsive">
            </div>
            ...
            <div class="w3ls_news_grids">
                <div class="col-md-4 w3ls_news_grid">
                    <div class="w3layouts_news_grid">
                        ...
                        <div class="w3layouts_news_grid_pos">
                            <div class="wthree_text">
                                <h3>Dry & Intermediate Zone (Rainfed)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="agileits_w3layouts_news_grid">
                        ...
                        <h4><a href="#" data-toggle="modal" data-target="#myModal">Paddy Crop Calendar -1</a></h4>
                ...
                <div class="col-md-4 w3ls_news_grid">
                    <div class="w3layouts_news_grid">
                        ...
                        <div class="w3layouts_news_grid_pos">
                            <div class="wthree_text">
                                <h3>Dry & Intermediate Zone (Irrigated)</h3>
                            </div>
                        </div>
                    </div>
                    <div class="agileits_w3layouts_news_grid">
                        ...
                        <h4><a href="#" data-toggle="modal" data-target="#myModal">Paddy Crop Calendar -2</a></h4>
                ...
                <div class="col-md-4 w3ls_news_grid">
                    ...
                    <div class="agileits_w3layouts_news_grid">
                        ...
                        <h4><a href="#" data-toggle="modal" data-target="#myModal">Paddy Crop Calendar -3</a></h4>
            ...
            <div class="w3agile_footer_grids">
                <div class="col-md-3 agileinfo_footer_grid">
                    <div class="agileits_w3layouts_footer_logo">
                        <h2><a href="/"><span>F</span>ieldSpark<i>Grow healthy products</i></a></h2>
                    </div>
                </div>
